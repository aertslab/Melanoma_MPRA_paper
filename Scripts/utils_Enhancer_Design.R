process.enh.cDNA.plasmid <- function(env, 
  ...
  # Assign tile class
  # First assign for all enhancers 'unassigned'
  # Then you can grep specific characters and put a global name for the groups of enhancers
  env[[line]]$merged$class <- "unassigned"
  env[[line]]$merged[grep(pattern = "A_group1", x = env[[line]]$merged$synthetic.region), "class"] <- "A_group1"
  env[[line]]$merged[grep(pattern = "A_group2", x = env[[line]]$merged$synthetic.region), "class"] <- "A_group2"
  env[[line]]$merged[grep(pattern = "A_group3", x = env[[line]]$merged$synthetic.region), "class"] <- "A_group3"
  env[[line]]$merged[grep(pattern = "A_group4", x = env[[line]]$merged$synthetic.region), "class"] <- "A_group4"
  env[[line]]$merged[grep(pattern = "B1_group1", x = env[[line]]$merged$synthetic.region), "class"] <- "B1_group1"
  env[[line]]$merged[grep(pattern = "B1_group2", x = env[[line]]$merged$synthetic.region), "class"] <- "B1_group2"
  env[[line]]$merged[grep(pattern = "B1_group3", x = env[[line]]$merged$synthetic.region), "class"] <- "B1_group3"
  env[[line]]$merged[grep(pattern = "B1_group4", x = env[[line]]$merged$synthetic.region), "class"] <- "B1_group4"
  env[[line]]$merged[grep(pattern = "B1_group5", x = env[[line]]$merged$synthetic.region), "class"] <- "B1_group5"
  env[[line]]$merged[grep(pattern = "B2_group1", x = env[[line]]$merged$synthetic.region), "class"] <- "B2_group1"
  env[[line]]$merged[grep(pattern = "B2_group2", x = env[[line]]$merged$synthetic.region), "class"] <- "B2_group2"
  env[[line]]$merged[grep(pattern = "B2_group3", x = env[[line]]$merged$synthetic.region), "class"] <- "B2_group3"
  env[[line]]$merged[grep(pattern = "C_group1", x = env[[line]]$merged$synthetic.region), "class"] <- "C_group1"
  env[[line]]$merged[grep(pattern = "C_group2", x = env[[line]]$merged$synthetic.region), "class"] <- "C_group2"
  env[[line]]$merged[grep(pattern = "C_group3", x = env[[line]]$merged$synthetic.region), "class"] <- "C_group3"
  env[[line]]$merged[grep(pattern = "Neg-Control", x = env[[line]]$merged$synthetic.region), "class"] <- "Neg-Control"
  env[[line]]$merged[grep(pattern = "Random_sequence_trial2", x = env[[line]]$merged$synthetic.region), "class"] <- "Random_sequence_trial2"
  env[[line]]$merged[grep(pattern = "Random_sequence_trial3", x = env[[line]]$merged$synthetic.region), "class"] <- "Random_sequence_trial3"
  env[[line]]$merged[grep(pattern = "S4_MEL", x = env[[line]]$merged$synthetic.region), "class"] <- "S4_MEL"
  env[[line]]$merged[grep(pattern = "S4_MES", x = env[[line]]$merged$synthetic.region), "class"] <- "S4_MES"
  env[[line]]$merged[grep(pattern = "S4_combi", x = env[[line]]$merged$synthetic.region), "class"] <- "S4_combi"
  env[[line]]$merged[grep(pattern = "S5_MEL", x = env[[line]]$merged$synthetic.region), "class"] <- "S5_MEL"
  env[[line]]$merged[grep(pattern = "S5_MES", x = env[[line]]$merged$synthetic.region), "class"] <- "S5_MES"
  env[[line]]$merged[grep(pattern = "S5_combi", x = env[[line]]$merged$synthetic.region), "class"] <- "S5_combi"
  env[[line]]$merged$class <- as.factor(env[[line]]$merged$class)
  warning("[OK]\n")
  ...
  shuffled <- env[[line]]$merged.input.norm[grep(pattern = "Neg-Control", x = env[[line]]$merged.input.norm$synthetic.region),]
  ...
  if (keep.shuffled == F) {
    env[[line]]$merged.input.basal.norm <- env[[line]]$merged.input.basal.norm[!(env[[line]]$merged.input.basal.norm$class == "Neg-Control"),]
  }
  warning("[OK]\n")
  ...
  warning("Estimation of active enhancers...\n")
  sample <- env[[line]]$merged.input.basal.norm
  subsettype <- c("C_group3", "Neg-Control", "Random_sequence_trial2", "Random_sequence_trial3")
  ...
  print(paste0("Number of Negative control sequences with padj < 0.05: ",nrow(env[[line]]$merged.input.basal.norm[env[[line]]$merged.input.basal.norm$padj < 0.05 & env[[line]]$merged.input.basal.norm$class == "Neg-Control",])))
  ...
  # Violin plots - expression per class (input norm)
  plot4 <- ggplot(data = env[[line]]$merged.input.norm, aes(x = class, y = log2(CPM.InputNorm), fill = class)) +
    geom_violin() +
    geom_jitter(shape=16, position=position_jitter(0.2), cex = 0.8) +
    geom_hline(yintercept = log2(basal.ex), linetype="dashed", color = "red", size = 0.5) +
    ...
    labs(x = "Class", y = "Log2 FC Input Normalized", title = paste0(environmentName(env), " - ", line))
  # print(plot4)
  
  # Violin plots - expression per class (input basal norm)
  plot5 <- ggplot(data = env[[line]]$merged.input.basal.norm[!env[[line]]$merged.input.basal.norm$class %in% c("C_group3", "Random_sequence_trial2", "Random_sequence_trial3"),], aes(x = class, y = log2(CPM.Input.BasalNorm), fill = class)) +
    geom_violin() +
    geom_jitter(data = env[[line]]$merged.input.basal.norm[!env[[line]]$merged.input.basal.norm$class %in% c("C_group3", "Random_sequence_trial2", "Random_sequence_trial3") & env[[line]]$merged.input.basal.norm$padj < 0.05,], shape = 16, position = position_jitter(0.2), cex = 0.8) +
  ...
  plot7 <- ggplot(data = env[[line]]$merged.input.basal.norm, mapping = aes(x = padj < 0.1, fill = class)) + 
    geom_bar(alpha = .8) +
    theme_minimal() +
    labs(fill = "Class")
  print(plot7)
